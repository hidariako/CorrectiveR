...
const contractABI = require("../artifacts/contracts/Correctiverag.sol/Correctiverag.json").abi;

program
    .name("correctiverag-cli")
    .description("CLI tool for Correctiverag smart contract")
    .version("1.0.0");
